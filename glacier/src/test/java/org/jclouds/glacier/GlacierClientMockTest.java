...
public class GlacierClientMockTest {
   ...
   public void testCompleteMultipartUpload() throws IOException, InterruptedException {
      ...
      String partHashcode = "9bc1b2a288b26af7257a36277ae3816a7d4f16e89c1e7e77d0a5c48bad62b360";
      ImmutableMap.Builder<Integer, HashCode> mapBuilder = ImmutableMap.builder();
      ...
      assertEquals(client.completeMultipartUpload(VAULT_NAME, MULTIPART_UPLOAD_ID, mapBuilder.build(), 8L), ARCHIVE_ID);
      RecordedRequest request = server.takeRequest();
      assertEquals(request.getRequestLine(),
