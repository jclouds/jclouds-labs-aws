...
public class GlacierClientMockTest {
   ...
   public void testUploadArchive() throws IOException, InterruptedException {
      ...
      mr.addHeader("x-amz-sha256-tree-hash", "beb0fe31a1c7ca8c6c04d574ea906e3f97b31fdca7571defb5b44dca89b5af60");
      mr.addHeader(
            "Location",
      ...
      // Send the request and check the response
      try {
         String id = client.uploadArchive("examplevault", payload, description);
         RecordedRequest request = server.takeRequest();
